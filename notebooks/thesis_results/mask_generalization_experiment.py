...
#         models_config = 'segmentation/multimodal/Feng/mvfusion' 
    ...
    print("FLIPPING MASK ID IN DATASET GETITEM!")
    print(f"Loading Network trained on {args.input_mask} but evaluating on the other one!")
    if args.input_mask == 'ViT_masks':
        load_mask = 'm2f_masks'
    elif args.input_mask == 'm2f_masks':
        load_mask = 'ViT_masks'
    
    cfg.data.m2f_preds_dirname = load_mask
    print(f"Loading {load_mask}")
