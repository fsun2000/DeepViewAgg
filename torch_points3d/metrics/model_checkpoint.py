    ...
    def load(
        ...
        if not os.path.exists(checkpoint_file):
            ...
            if strict or resume:
                ...
                message = f"The provided path {checkpoint_dir} didn't " \
                          f"contain the checkpoint_file {checkpoint_name}.pt"
...
class ModelCheckpoint(object):
    ...
    Argumemnts:
        ...
        - strict: If strict and checkpoint is empty then it raises a ValueError.
          Being in resume mode forces strict
    """
