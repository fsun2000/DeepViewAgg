...
from torch_points3d.applications.multimodal.Feng.mvfusion_orig import MVFusionEncoder_orig
...
class MVFusion_orig(BaseModel, ABC):
...
#             raise NotImplementedError
        ...
        self.MAX_N_POINTS = option['backbone']['transformer']['max_n_points']
...
#             #  gradient from the view loss and hence will not be trained.
    ...
    def set_input(self, data, device):
        ...
        if data.data.mvfusion_input.shape[0] > self.MAX_N_POINTS \
