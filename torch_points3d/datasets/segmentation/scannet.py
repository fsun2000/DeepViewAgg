...
def download_release(release_scans, out_dir, file_types, use_v1_sens):
    ...
    print("exiting on line 162 in DeepViewAgg/torch_points3d/datasets/segmentation/scannet.py")
...
def download_scan(scan_id, out_dir, file_types, use_v1_sens):
    print("Tried to download scans!")
    print("exiting on line 199 in DeepViewAgg/torch_points3d/datasets/segmentation/scannet.py")
    raise ImplementationError
...
def export(mesh_file, agg_file, seg_file, meta_file, label_map_file, output_file=None):
    ...
    """
#     print("Tried to export mesh data!")
#     print("exiting on line 336 in DeepViewAgg/torch_points3d/datasets/segmentation/scannet.py")
#     raise ImplementationError
...
#         return
    ...
    def process_func(
        ...
        print("{}/{}| scan_name: {}, data: {}".format(id_scan, total, scan_name, data), flush=True)
